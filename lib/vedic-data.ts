...
export const RASHI_DATA: Record<Rashi, RashiData> = {
  ...
  Vrishchika: { sanskrit: 'Vrishchika', english: 'Scorpio',     symbol: '♏', ruler: 'Mars',    rulerSk: 'Mangala',   element: 'Water', quality: 'Fixed',   polarity: 'Feminine',  color: '#c2410c', description: 'The Scorpion, alchemist, investigator, mystic. Vrishchika is deep water ruled by Mars. Intense, secretive, transformative. Drawn to taboo and hidden truth. The healer who has descended into darkness and returned.' },
  ...
  Makara:     { sanskrit: 'Makara',     english: 'Capricorn',   symbol: '♑', ruler: 'Saturn',  rulerSk: 'Shani',     element: 'Earth', quality: 'Movable', polarity: 'Feminine',  color: '#94a3b8', description: 'The Sea-Goat, climber, builder, elder. Makara is earth ruled by Saturn. Disciplined, ambitious, structured. Those who rise through patient effort and bear responsibility as a sacred duty.' },
